...
export class RecipesSearchService {
  ...
  public url_derivedRecipe = 'https://localhost:44356/api/DerivedRecipe';
  ...
  public url_derivedTag = 'https://localhost:44356/api/DerivedTag'
...
export class DerivedRecipe{
  ...
  constructor(name: string, DerivedRecipeFile: string, idUser: number, idRecipe: number){
    this.name = name;
